...
Output: `data/processed/drivelm_visual_pref_v1_train.jsonl`
Pairs: `3200`
...
| normal_repair_gold_over_bad_prediction | 643 |
| normal_anchor_gold_over_refusal | 600 |
...
| name | count |
|---|---:|
| spatial_localization | 2000 |
| object_recognition | 583 |
| reasoning_world_knowledge | 379 |
| scene_completeness | 193 |
| counting | 41 |
...
| normal_repair_added | 643 |
| normal_anchor_added | 600 |
