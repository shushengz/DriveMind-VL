...
python src/train_qwen25vl_lora.py \
  ...
  --train_file data/processed/lingoqa_sft_v1_final_visual57.jsonl \
  --output_dir outputs/checkpoints/qwen25vl_3b_lingoqa_sft_v1_final_visual57_smoke \
  --max_samples "${MAX_SAMPLES:-57}" \
  --epochs "${EPOCHS:-1}" \
