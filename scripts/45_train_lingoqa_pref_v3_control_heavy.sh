...
python src/train_qwen25vl_dpo_lora.py \
  ...
  --train_file "${TRAIN_FILE:-data/processed/lingoqa_preference_v3_control_heavy_train.jsonl}" \
  --output_dir "${OUTPUT_DIR:-outputs/checkpoints/qwen25vl_3b_lingoqa_pref_v3_control_heavy}" \
