"""Build the Stage 6 held-out comparison table from saved raw predictions."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Aggregate Stage 6 held-out DPO-v8 comparisons.")
    ...
    parser.add_argument("--output", default="outputs/final_report/stage6_dpo_v8_heldout_main_results.csv")
    parser.add_argument("--warnings_output", default="outputs/final_report/stage6_dpo_v8_heldout_main_results_warnings.json")
